      ...
      <form onSubmit={this.props.createItem}>
        <div className="flex justify-between w-full">
          <div className="flex items-center gap-1">
            ...
            <button data-key={this.props.job.key} onClick={this.props.editJob}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <div className="flex justify-end">
            <input
              ...
              defaultValue={this.props.job.company}
              onChange={this.props.updateCompany}
              data-key={this.props.job.key}
            ></input>
            ...
            <input
              ...
              defaultValue={this.props.job.start}
            ...
            <input
              type="text"
              className="bg-gray-300 p-1 text-sm font-medium rounded border-2 border-gray-500 w-2/12 md:w-1/12"
              defaultValue={this.props.job.end}
