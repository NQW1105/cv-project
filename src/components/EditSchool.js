      ...
      >
        <div className="flex items-center gap-1">
          <input
            ...
            defaultValue={this.props.education.qualification}
            onChange={this.props.updateQualification}
            data-key={this.props.education.key}
          ></input>
          <button
            data-key={this.props.education.key}
            onClick={this.props.delEducation}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="bi bi-trash-fill h-5 hover:fill-red-700 pointer-events-none"
              viewBox="0 0 16 16"
            >
        ...
        <div className="flex justify-end">
          <input
            ...
            defaultValue={this.props.education.provider}
            onChange={this.props.updateProvider}
            data-key={this.props.education.key}
          ></input>
          ...
          <input
            ...
            defaultValue={this.props.education.start}
